...
const styles = {
  ...
  navbarTitleInactive : "text-2xl md:text-base w-full text-left border-none focus:outline-none bg-transparent block py-2 text-textlight md:p-0 dark:text-textdark dark:hover:text-tertiarydark hover:text-tertiary transition ease-in-out",
