...
const styles = {
  ...
  sidebarTitles: "p-4 pl-0 md:pl-4 pt-3 pb-2 pt-2 font-semibold text-xl",
  sidebarContent: "p-4 pt-0 pb-0 text-md",
  ...
  badge: "gap-1.5 py-1 px-3 m-1 rounded-full text-xs font-medium hover:border-cyan-400 border-cyan-500 dark:hover:border-cyan-300 dark:border-cyan-600 border-[2px] text-textlight dark:text-textdark"
};
