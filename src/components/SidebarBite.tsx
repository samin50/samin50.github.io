...
function SidebarBite() {
    ...
    return (
        <>
            <div className={`${isSidebarVisible ? 'w-1/4' : 'hidden'} w-11/12 md:w-1/4 md:block bg-primary border-secondary dark:bg-primarydark dark:border-secondarydark border-r-[3px] dark:text-textdark text-textlight flex flex-col`}>
            ...
            <div className="md:hidden fixed h-full flex items-end pb-20 pl-3 dark:border-secondarydark border-secondary">
                <button className="bg-primary dark:bg-primarydark dark:border-tertiarydark border-tertiary border-[3px] opacity-30 hover:opacity-100 transition-opacity 500 p-0 rounded-full focus:outline-none" onClick={handleSidebarClick}>
