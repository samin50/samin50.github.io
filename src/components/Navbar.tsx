  ...
  return (
    <div className="dark:bg-primarydark bg-primary border-secondary dark:border-secondarydark border-b-[3px] sticky top-0 flex flex-col md:flex-row md:items-center transition-colors 1000 ease-in-out w-screen min-h-[50%] z-10">
      ...
      <div className={`${isNavbarVisible ? '' : 'hidden'} w-full md:block md:w-auto p-3`} id="navbar-multi-level">
        <ul className="flex flex-col font-medium p-3 md:p-0 mt-2 border rounded-md md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:border-secondary border-secondary">
          <li>
