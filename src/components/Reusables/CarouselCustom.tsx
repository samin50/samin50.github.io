  ...
  return (
    <div className={`${className} flex flex-col items-center space-y-4`}>
      <div className="relative h-72 w-full border-2 rounded-lg border-secondary dark:border-secondarydark flex items-center p-1">
        <button onClick={prevMedia} className="absolute left-2 z-10 border-none fill-white hover:fill-gray-400 transition-colors duration-150">
        ...
        <button onClick={nextMedia} className="absolute right-2 z-10 border-none fill-white  hover:fill-gray-400 transition-colors duration-150">
