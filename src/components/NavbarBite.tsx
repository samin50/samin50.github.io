...
function NavbarBite() {
  ...
  return (
    <div className="bg-primary border-secondary dark:bg-primarydark dark:border-secondarydark border-b-[3px] sticky top-0 flex flex-col md:flex-row md:items-center">
      <div className="w-screen flex flex-wrap items-center justify-between mx-auto p-3 md:p-4">
        ...
        <div className="flex items-center">
            ...
            <div className="flex flex-col">
              <div className="text-textlight dark:text-textdark font-bold text-lg/4 md:text-xl/4 py-0">Shaheen Amin</div>
              <div className="text-textlight dark:text-textdark text-sm/4 md:text-base py-0">Engineer, Programmer and DIY Enthusiast</div>
            </div>
        </div>
        {/* Dark Mode button */}
        <div className="flex items-center">
          {/* md:top-5 top-4  */}
          <button id="theme-toggle" type="button" className="focus:outline-none border-secondary hover:border-tertiary text-textlight dark:text-textdark rounded-lg text-sm p-2.5">
      ...
      <div className={`${isNavbarVisible ? '' : 'hidden'} w-full md:block md:w-auto p-3`} id="navbar-multi-level">
        <ul className="flex flex-col font-medium p-3 md:p-0 mt-2 border rounded-md bg-primary md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-primary dark:bg-primarydark md:dark:bg-primarydark dark:border-secondary">
          ...
          <li>
              ...
              <div id="dropdownNavbar" className={`${isDropdownVisible ? '' : 'hidden'} font-normal bg-primary rounded-lg shadow w-44 dark:bg-secondarydark`}>
